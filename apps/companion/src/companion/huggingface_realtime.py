...
from companion.tools import core_tools
...
from companion.streaming import AdditionalOutputs, audio_to_int16
from companion.tools.core_tools import (
    ToolSpec,
    ToolDependencies,
    get_tool_specs,
)
from companion.conversation_handler import ConversationHandler
from companion.tools.background_tool_manager import (
    ToolCallRoutine,
    ToolNotification,
...
class HuggingFaceRealtimeHandler(ConversationHandler):
    ...
    async def apply_personality(self, profile: str | None) -> str:
        ...
        try:
            ...
            from companion.config import config as _config
