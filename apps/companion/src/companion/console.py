...
from companion.streaming import AdditionalOutputs, audio_to_float32
from companion.startup_settings import read_startup_settings, write_startup_settings
from companion.tools.core_tools import initialize_tools
from companion.personality_routes import (
    build_personality_ops,
    register_personality_methods,
)
from companion.audio.startup_config import apply_audio_startup_config
...
class LocalStream:
    ...
    def _persist_personality(self, profile: Optional[str], voice_override: Optional[str] = None) -> None:
        ...
        try:
            from companion.config import set_custom_profile
    ...
    async def apply_personality(self, profile: Optional[str]) -> str:
        ...
        try:
            from companion.config import set_custom_profile
            from companion.prompts import get_session_voice, get_session_instructions
    ...
    def get_current_voice(self) -> str:
        ...
        try:
            from companion.prompts import get_session_voice
