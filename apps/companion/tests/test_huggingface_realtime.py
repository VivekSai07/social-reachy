...
import companion.conversation_handler as conv_mod
import companion.huggingface_realtime as hf_mod
from companion.config import config, get_default_voice
...
from companion.tools.background_tool_manager import ToolState, ToolNotification
