...
import companion.prompts as prompts_mod
import companion.personality as headless_mod
from companion.config import DEFAULT_PROFILES_DIRECTORY, config
...
#     \spaces--pollen-robotics--companion
...
#   back to the budget: 101 + len("companion\") (29) = 130.
#
...
def test_explicit_default_profile_does_not_fall_back_to_itself(
    ...
    with caplog.at_level(logging.WARNING, logger="companion.prompts"):
