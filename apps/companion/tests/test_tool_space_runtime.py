...
import companion.tool_spaces as tool_spaces_mod
...
def _reload_core_tools() -> ModuleType:
    for module_name in list(sys.modules):
        if module_name.startswith("companion.tools."):
            sys.modules.pop(module_name, None)

    sys.modules.pop("companion.tools.core_tools", None)
    return importlib.import_module("companion.tools.core_tools")
