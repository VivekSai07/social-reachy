...
import companion.personality as personality_mod
from companion.config import config
from companion.avatars import (
    DEFAULT_AVATAR_FILE,
    avatar_id_for,
    read_avatar_svg,
)
from companion.personality import DEFAULT_OPTION
...
def test_avatar_unavailable_raises(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "companion.personality_routes.read_avatar_svg",
        lambda name: None,
    )
